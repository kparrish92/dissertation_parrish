...
Parrish (2021) examined Mexican Spanish-English bilinguals who produced French words in isolation at first exposure to the language. 
The results found that the relative VOT of the L3 fell between their own L1 and L2 values, in line with previous research (citations). 
...
To date, few studies in L3 phonology has incorporated the predictions of the perceptual assimilation model

**Wrembel et al. (2019)** examined the categorization and discrimination of 10 young trilinguals who spoke L1 German-L2 English-L3 Polish.
...
Werker (1986), Patihis, Oh and Mogilner (2015), Kopečková (2015), Cabrelli Amaro (2016), Onishi (2016), and Wrembel, Marecka and Kopečková (under review).
