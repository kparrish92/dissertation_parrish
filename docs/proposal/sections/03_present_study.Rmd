...
The predictions in Table 1 are those that would support the idea that cross linguistic acoustic similarity drives CLI patterns in L3A.
...
The stimulus sounds will be similar to the vowel sounds in the production sentences, and are listed in table 2. 
