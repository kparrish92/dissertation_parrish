...
The present study investigates the production and perception of words in a language by bilinguals that they do not yet know, specifically, French or German. <!-- words? or segments via words --> 
In so doing, the present dissertation aims to investigate the very initial stage of acquisition by providing an overview of the initial relative influence of both L1 and L2. <!-- initial stage of L3 phonological acquisition --> 
...
Following these tasks, the link between perception and production will be discussed. <!-- discussed? or analyzed (and discussed)? --> 

# Research Questions 

The present dissertation is guided by the following research questions. 
Broadly, this project focuses on the influence of L1 and L2 system on L3 perception and production, and how cross-linguistic similarity might predict this influence. <!-- ...of THE L1 and L2 systems... --> 
...
The evidence in support of L3 models and their predictions is also identical in the case of vowels. <!-- Say they are the same (that's fine), but repeat them again here anyway to be complete. --> 
...
In @parrish_relative_2021, L1 Spanish-L2 English bilinguals shadowed French, which is phonetically similar to Spanish in its use of VOT to distinguish stop consonants. <!-- is this study submitted somewhere? --> 
...
That is, for example, if L1 Spanish-L2 English speakers aspirate German and French at the same rates, despite the German tokens being aspirated and French tokens being unsaturated, then the aspiration of the input would not reliably predict L3 production patterns. <!-- unsaturated? --> 
...
Additionally, German and English and French and Spanish are typologically related in a global sense. <!-- What does global sense mean here? --> 
...
```{r, echo=FALSE, out.width="70%", fig.cap="Figure 1"}
...
```{r, echo=FALSE, out.width="70%", fig.cap="Figure 2"}
...
The task will be programmed in Psychopy [@peirce_psychopy2_2019]. <!-- are you creating all the stimuli yourself or have they been used in previous studies? --> 

## Procedure 

Participants will complete the experimental tasks in a semi-longitudenal fashion, in which each participant will complete 1 of 4 language specific blocks on different dates. 
