...
For instance, **Bohnacker(2006)** Found that L1 Swedish-L2 English-L3 German speakers showed evidence of English like word order in L3 German V2 contructions, rather than facilitative L1 Swedish,
Additionally, *falk and bardel 2011** found that 44 L3 German learners with L1 English-L2 French or L1 French-L2 English behaved differently in tasks involving object pronoun placement.
...
In order to test whether bilinguals have access to two languages during L3 learning, *Mitronova & Westergaard (2018)* conducted a study Norwegian-Russian bilinguals and Norwegian monolinguals in which they taught them some of an aritificial language which was designed to contain Norwegian-like lexical items, but also Russian like case marking to distinguish subjects from objects.
...
In a series of studies, **Stadt 2016** examined L1 Dutch - L2 English - L3 French speakers in both English immersion and general Dutch-dominant educational settings. 
...
In a follow up study **stadt 2018**, the authors recruited 4th year students from the same educational background to investigate whether L2 influence would differ between 3rd and 4th year students. 
...
In a second follow up study **2020**, the authors gave similar materials to the an L3 German group.
...
Interstingly, these authors also conducted longitudinal study (**Stadt long 2018**), again with L1 Dutch-L2 English-L3 French speakers.
...
Additionally, it is notable that the empirical studies that serve as the basis of the LPM **westergaard studies** utilize groups of simultaneous bilinguals, which do not allow for the examination of potential L2 status effects. 
