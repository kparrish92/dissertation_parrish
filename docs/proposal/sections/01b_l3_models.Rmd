...
In a study of L3 learners of a V2 language who spoke a V2 L1 and non-V2 L2, *Falk Lind Bardel*, participants were given a survey which measured their awareness of cross-linguistic features in their known languages. 
...
44 L3 German learners with L1 English-L2 French or L1 French-L2 English. Object pronoun placement.
Groups behaved differently, in which their L2 was found to be the likely factor guiding their responses. 
...
Despite these results, the authors posited that it was possible that the perception of cross-linguistic structural similarity (or so called phycho-typology **Kellerman, 1983**) could also be a potential explanation for the results obtained in [@rothman_what_2010].
...
Stadt, Hulk, and Sleeman (2016, 2018a, 2018b, 2020),

Ben Abbes (2016, 2020) 

Kolb et al. under review <- accepted international journal of bilingualism 
Lloyd-Smith (2020) 
...
Following this idea, @westergaard_crosslinguistic_2017 suggest that an optimal design to examine both the invididual contributions of languages, as well as potential language status effects, would be the so-called fully combined design. 
