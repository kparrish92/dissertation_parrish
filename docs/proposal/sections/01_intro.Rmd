...
Empirical studies in L3 phonological acquisition have found evidence of multi-directional influence in language production [@llama_influence_2010; @llama_revisiting_2018], with the impact of previously learned languages on a third varying. <!-- "varying" at the end sounds a bit odd --> 
...
An issue with the use of few participants to make generalizations is that it cannot reliably rule out false findings (type 1 and type 2 error) due to an insufficient quantity of samples from a hypothetical population distribution to reliably infer information about that group. <!-- I dont know that I would call a false negative a type of finding... it's the absense of a finding. Maybe say "...it increases the likelihood of false positives and false negatives" --> 
...
This conclusion is not well justified, since it is unclear if null results are due to low samples with wide confidence intervals and how much noise is expected in the data. <!-- this is the perfect opportunity to say something to the effect of absense of evidence is not evidence of absense... in other words the lack of a significant p-value is not evidence for the null --> 
...
Language dominance and use has not always been considered in L3 studies. <!-- "These L3 proficiency has varied" ...missing something --> 
...
Current models of L3A do not always account for potential individual differences in CLI, and typically are restrictive in their predictions. <!-- did you define L3A yet? --> 
...
Stops with a positive VOT are considered phonetically voiceless. <!-- while youre at it you should define phonetically voiced --> 
...
The phoneme /b/, on the other hand, is often realized with a short-lag positive VOT in aspirating languages, in which it likely has acoustic/phonetic overlap with the true-voicing language /p/. <!-- The information is all there, but you explain it in a way that seems to make it more complicated than it is. Make it more clear that true voicing languages have lead and short-lag VOT, aspirating languages have short-lag and long-lag VOT. No need to beat around the bush. --> 
...
Another useful object to examine cross-linguistic influence is the vowel inventory of each language. <!-- object? --> 
Studies examining the articulatory space of vowels typically involve spectral measurements such as formant frequencies. 
In these studies, the frequency in Hertz of the at least first and second formants are measured and plotted for each vowel. <!-- Id just say frequency (not hertz), because many people use other measures (like mels, ebs, etc.). Also, measure and plotted... I mean yeah, but plotting them isnt really necessary. The key is that the formant frequencies are compared --> 
...
The Spanish vowel space is the smallest of the present study and consists of 5 distinct vowel monopthong categorizations [@bradlow_comparative_1995]. 
English, French and German have larger relative vowel spaces, where English has 11 monopthongs, and German has 14 [@jongman_acoustic_1989; @bradlow_comparative_1995].
...
That is, previous research has identified patterns in learning novel vowel contrasts, where some are easier than others and this ease is driven by cross-linguistic similarity. <!-- maybe a few refs here --> 
A main question of the present dissertation is whether this cross-linguistic similarity affects the learning of L3 sounds, and whether the L1 and L2 vowel proportionally affect this process, or if the L1 or L2 has privileged status. <!-- I think you need to make this more clear. It also sounds like more than one question. --> 
