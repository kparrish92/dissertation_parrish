...
1. What determines how bilinguals approach a third language? 
...
2. How is the sound system of a new language learned?
...
- in the task, sounds are played for a naive speaker of a language where the speaker is given categories to choose from 

- The speaker chooses which category best corresponds to the sound heard 

- They then rate their choice for goodness of fit. 

**add screenshot of task with only english**
