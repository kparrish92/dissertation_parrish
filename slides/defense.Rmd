...
- Less is known about L3 phonology.
  - In L3 learning, **L1 and L2 phonetic cateogories exist.**
]
...
- Structure-by-structure influence from L1 and L2.
...
.big[
.pull-left[
- Evidence for each model has received empirical support. 
...
.big[
.pull-left[
- **Potential improvement 1:** Studies only measure a single structure

- **Potential improvement 2:** Low power  

- **Potential improvement 3:** Inappropriate statistical tests  
]
]
...
.big[
.pull-right[
- **Proposal 1:** measuring productions of the same individual across conditions or structures
...
.big[
- Each participant will perceive and produce **two L3s**.
...
.big[
- Establishes criteria for equivalence and intermediate categories 
]
...
.big[
.white[
.blue[RQ1]: Does **order of acquisition** impact L1 and L2 influence of L3 *voice onset time* and *vowel* production and perception?

.blue[RQ2]: Does **language similarity** impact  L1 and L2 influence of L3 *voice onset time* and *vowel* production and perception?

.blue[RQ3]: How do language specific **acoustic cues** bias the influence of the L1 or the L2 in *voice onset time* and *vowel* production and perception?
...
.big[
- Foote (2009) and Rothman (2011) proposed **mirror image groups** of L3 bilinguals to tease apart potential language status effects from typological effects. 
]

???

In order to distinguish whether influence from a language is due to it being a first or senond language or typologically similar, some scholars have propose the use of a so-called mirror image design. 
...
The present study makes use of the fully combined design, recruiting four total groups. 
The "L3" groups wil be SPanish L1/English L2 bilinguals and English L1/Spanish L2 bilinguals exposed to an L3 
and the "L2" groups will be monolinguals exposed the a second language that they do not know. 

The groups will contain at least 80 participants each, have started learning their L2 after 13, and will all be recruited online via Prolfic.
...
The Spanish speakers will be from Mexico and the English speakers will be from the NE US. 
...
- The production experiments will comprise Chapter 2

- The perception experiments will be carried out in Chapter 3

- The link between pereption and production will be discussed in Chapter 4
]
...
.content-box-red[
.large[
- **English Condition 1:** /i/ 

- **English Condition 2:** wedge/schwa 

- **Spanish Condition 1:** /i/ 

- **Spanish Condition 2:** /o/  
]]]]

--

.pull-right[
- Presented in **/fVf/**, **/pVp/** frames

- Presented as real or non-words orthographically
 - Non-words: "Say X as if it rhymes with Y." 

- **Conditions 1:** vowel available in both languages

- **Condition 2:** language specific-vowel  
]
...
- Recorded by German and French L1 speakers

- Shadowed three times each
]
...
.full-width[
.large[
- Participants will hear tokens produced by either **L1 German** or **L1 French speakers**.

- Choices: Spanish and English words 

- Embedded in **/pVp/ or /fVf/ frames**.
  
- Choose which word contains the best example of the auditory vowel per trail.
...
.big[
- Measures discrimination of English contrasts. 
]

--

.big[
- **English contrasts:** *sheep-ship* and *pat-pot* continua are proposed.
]
 
--

.big[
- Produced in **fricative and bilabial** frames in **German and French**
]
